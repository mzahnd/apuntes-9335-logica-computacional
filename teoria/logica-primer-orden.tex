...
\begin{proof} \phantom{.}
    ...
    \end{figure}
    En ambos casos estamos usando el \fullref{teo:equiv-isomorfs}:
    \begin{gather*}
        \mathcal{I}_1 \vDash \alpha[v] 
        \iff \mathcal{I}_2 \vDash \alpha [h \circ v] 
    \end{gather*}
...
\begin{proof} \phantom{.}
    ...
    Aplicando el \fullref{teo:equiv-isomorfs}:
    \begin{gather*}
...
\begin{proof} \phantom{.}
    ...
    Sabemos que: 
    \nota{Por el \fullref{teo:equiv-isomorfs}}%
