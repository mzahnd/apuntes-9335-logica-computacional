...
\begin{itemize}
    % \vphantom{b} está para mostrar la recta a la misma altura en 'a' y 'b'
...
% Hack para mostrar G_n sin que hyperref se queje
...
La respuesta es que sí, por el \fullref{teo:base-tl}.
...
\item Conseguir una TL de $T: \mathbb{R}_2[x] \to \mathbb{R}^3$ tal que
    ...
    y después usar el \fullref{teo:base-tl} para extender a todo 
    $\mathbb{R}_2[x]$.
    ...
    Usando el \fullref{teo:base-tl}: existe una única
